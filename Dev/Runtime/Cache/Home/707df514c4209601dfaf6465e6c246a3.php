...
<meta name="renderer" content="webkit">
        ...
        <link rel="stylesheet" href="/www/Public/dev/css/valuate.css">
    </head>
    ...
    <div class="main_container assessnews">
        ...
        <ul class="assessnews-list js-assessnews-list">
            <?php for ($i=0; $i < count($records) / 3; $i++) { ?>
                ...
                <li class="item">
                    <?php $__FOR_START_2951__=0;$__FOR_END_2951__=3;for($j=$__FOR_START_2951__;$j < $__FOR_END_2951__;$j+=1){ ?><div class="assessnews-list-detail">
...
<div class="js-be-api m-be" >
	{
        ...
        <script src="/www/Public/dev/js/valuate.js" charset="utf-8"></script>
        <script src="/www/Public/dev/lib/js/jquery.SuperSlide.2.1.1.js" charset="utf-8"></script>
        <script src="/www/Public/dev/js/jquery.numberRun.js" charset="utf-8"></script>
