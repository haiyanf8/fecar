						...
						<ul>
							<?php if(is_array($img)): $i = 0; $__LIST__ = $img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li class="item">
								<div class="wrap-img">
									...
									data-origin="<?php echo C('CHECK_URL'); echo ($value['url']); ?>" alt="" />
								</div>
...
<div class="overview-pic-big js-overview-pic-big">
    <div class="slide-box js-overview-slide-box">
        <ul class="slide-box-img js-overview-slide-img">
            <?php if(is_array($img)): $i = 0; $__LIST__ = $img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($i == 0 ): ?><li class="active"><img src="<?php echo C('CHECK_URL'); echo ($val['url']); ?>" alt=""></li>
                <?php else: ?>
                    <li><img src="<?php echo C('CHECK_URL'); echo ($val['url']); ?>" alt=""></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
        </ul>
