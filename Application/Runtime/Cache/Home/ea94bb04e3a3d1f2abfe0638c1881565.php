...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/www/Public/prd/css/article-detail-af25ce514e.css">
    </head>
    <body>
...
<div class="pbl-aside-nav aside-nav">
	<ul>
		...
		<script src="/www/Public/prd/js/article-detail-0bcb2afa94.js" charset="utf-8"></script>
        <!-- IE8及以下支持JSON -->
        <!--[if lt IE 9]>
