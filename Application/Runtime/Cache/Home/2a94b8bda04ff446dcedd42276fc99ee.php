...
<meta name="renderer" content="webkit">
        ...
        <link rel="stylesheet" href="/www/Public/prd/css/index-59b5263f6f.css">
    </head>
    <body>
	...
	<div class="banner-header">
		<h1 class="logo">
		    <a href="./">
		        <img src="/www/Public/prd/img/source/pbl/head-logo.png"  alt="迈迈车官方网站-专业检测评估卖车平台,迈迈车LOGO" />
		    </a>
		</h1>
					...
					<?php if(is_array($bidedData)): $i = 0; $__LIST__ = $bidedData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="item deal-box-item">
							<div class="img">
								<a href="./history-detail/<?php echo ($vo['carid']); ?>.html">
									<img src="/www/Public/prd/img/source/pbl/history-detail-default.jpg" data-origin="<?php echo C('CHECK_URL'); echo ($vo['url']); ?>" >
								</a>
							</div>
	                    	<div class="info">
...
<div class="quicksale js-quicksale active">
	...
	<!-- <div class="quicksale-up js-quicksale-up">
		<img src="/www/Public/prd/img/pbl/quick-up-people.png">
	</div> -->
	...
	<div class="quicksale-pop js-quicksale-pop">
		...
		<div class="quicksale-pop-wrap">
			<div class="people">
				<img src="/www/Public/prd/img/pbl/quick-pop-people.png">
			</div>
			<div class="form">
				...
				<div class="form-ipt js-ipt-info">
					<span class="error js-quicksale-error"><img src="/www/Public/prd/img/pbl/quicksale-error.png"></span>
				</div>
			...
			<div class="form-intro">
				<p class="pic"><img src="/www/Public/prd/img/pbl/quicksale-logo.png"></p>
		...
		<div class="quicksale-pop-close js-quicksale-close">
			<img src="/www/Public/prd/img/pbl/asidesale-close.png">
		</div>
	</div>
</div>
...
<div class="js-be-api m-be" >
	{
        ...
        <script src="/www/Public/prd/js/pbl-9c48ff6cfc.js" charset="utf-8"></script>

        <script src="/www/Public/prd/js/index-088bbc7e96.js" charset="utf-8"></script>

        <script src="/www/Public/prd/js/numCountUp-4205e2edab.min.js" charset="utf-8"></script>
