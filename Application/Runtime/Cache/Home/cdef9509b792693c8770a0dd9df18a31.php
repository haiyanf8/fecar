...
<meta name="renderer" content="webkit">
        ...
        <link rel="stylesheet" href="/www/Public/prd/css/auction-detail-5bba561fce.css">
    </head>
    <body>
					...
					<div id="picBox" class="slide-picbox">
						...
						<ul>
							<?php if(is_array($img)): $i = 0; $__LIST__ = $img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li class="item">
								<div class="wrap-img">
									<img
									src="/www/Public/prd/img/source/pbl/history-detail-default.jpg"
	...
	<div class="checkup-testman">
		<?php if($carDetailInfo['car_area'] == '350200'): ?><img src="/www/Public/prd/img/source/surveyor/xm.jpg" alt="">
			<p class="ct">马腾辉</p>
...
<div class="pbl-aside-nav aside-nav">
	<ul>
        ...
        <script src="/www/Public/prd/js/auction-detail-5511acdbc8.js" charset="utf-8"></script>
        <!-- IE8及以下支持JSON -->
        <!--[if lt IE 9]>
